...
public class Endereco implements Serializable {
	...
	public String toString() {
		return "Endereco [id_end=" + id_end + ", coplemento_end=" + complemento_end + ", logradouro_end="
				+ logradouro_end + ", numero_end=" + numero_end + ", cidade_end=" + cidade_end + ", bairro_end="
				+ bairro_end + ", pont_ref_end=" + pont_ref_end + "]";
	}
}
